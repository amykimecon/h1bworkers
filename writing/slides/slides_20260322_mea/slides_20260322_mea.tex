...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            \item I investigate various channels: measurement error \& OPT fallback seem to matter, but don't fully account for small effects
        \end{itemize}
    \end{enumerate} \vspace{2mm}
    \only<2>{\textbf{Empirical Puzzle:} How are lottery losers managing to stay?}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item \textbf{Baseline:} keep unrestricted sample, collapse at application level, drop singleton firms (FEs not identified) (N = 70,580)
        \vspace{2mm}
...
\begin{frame}
    ...
    \begin{itemize}
        \item \textbf{Location:} In U.S., in home country, in non-U.S. non-home country \vspace{4mm}
        \item \textbf{Employment:} still at same firm, new position conditional on same firm (proxy for promotion) \vspace{4mm}
