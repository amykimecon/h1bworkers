...
\begin{frame}
    ...
    & (1) & (2) & (3) & (4) \\
    \midrule
    winner & 0.0210 & 0.0324\sym{**} & 0.0395\sym{**} & 0.0446\sym{**} \\
     & (0.0195) & (0.0138) & (0.0164) & (0.0194) \\
    \midrule
    \textbf{Control mean} & 0.893 & 0.880 & 0.870 & 0.875 \\
    ...
    \end{center}
    \begin{center}
    \scriptsize\textit{Outcome: \textit{In U.S.}\ (2 years post-lottery). Cols (1)--(4): subgroups by years since graduation at time of lottery application. $^*p<0.10$, $^{**}p<0.05$, $^{***}p<0.01$.}
    \end{center}
    \vfill
\end{frame}
...
%%% HETEROGENEITY TABLE (FULL)
\begin{frame}
    \frametitle{Effects Concentrated at Firms That Don't Re-Sponsor}
    \vfill
    \begin{center}
    \resizebox{0.5\textwidth}{!}{%
    \begin{tabular}{lcc}
    \toprule
    & \multicolumn{2}{c}{\textit{Dependent Variable: In U.S.}} \\
    & No rep. & High rep. \\
    & (1) & (2) \\
    \midrule
    winner & 0.0221 & 0.0029 \\
     & (0.0211) & (0.0064) \\
    \midrule
    \textbf{Control mean} & 0.889 & 0.920 \\
    \textbf{N} & 2{,}605 & 19{,}322 \\
    \bottomrule
    \end{tabular}
    }
    \end{center}
    \begin{center}
    \scriptsize\textit{Outcome: \textit{In U.S.}\ (2 years post-lottery). Cols (1)--(2): subgroups by employer repetition. $^*p<0.10$, $^{**}p<0.05$, $^{***}p<0.01$.}
    \end{center}
    \vfill
\end{frame}
